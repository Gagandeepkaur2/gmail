     ...
     <span class="material-symbols-outlined" style="margin-left: 20px">menu</span>
	  <div class="collapse navbar-collapse " id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
		  ...
		  <form class="form-inline d-flex justify-content-around w-100">
	      <input class="form-control mr-sm-2" type="search" placeholder="Search in mail" aria-label="Search" style="width: 600px; ">
